                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/pengaduan/store" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" id="selesai" value="selesai" name="status" class="" placeholder="">Selesai</input>
                            <input type="radio" id="proses" value="proses" name="status" class="" placeholder="">Proses</input>
