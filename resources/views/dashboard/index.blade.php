...
<head>
    <title>Pengaduan Masyarakat Tarwini</title>
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            ...
                                            <a href="/logins"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Table Master</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="/pengaduan">
                                                ...
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Pengaduan</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" ">
                                            <a href="/tanggapan">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Tanggapan</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        @endif
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <i class="ti-truck bg-c-pink card1-icon"></i>
                                                        <span class="text-c-pink f-w-600">Petugas</span>
                                                        <h4></h4>
                                                        <div>
                                                            <span class="f-left m-t-10 text-muted">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <i class="ti-announcement bg-c-green card1-icon"></i>
                                                        <span class="text-c-green f-w-600">Pengaduan</span>
                                                        <h4></h4>
                                                        <div>
                                                            <span class="f-left m-t-10 text-muted">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <i class="ti-pencil-alt bg-c-yellow card1-icon"></i>
                                                        <span class="text-c-yellow f-w-600">Tanggapan</span>
                                                        <h4></h4>
                                                        <div>
                                                            <span class="f-left m-t-10 text-muted">
